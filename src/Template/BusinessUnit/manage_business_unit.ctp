    ...
    <section class="content-header">
      ...
      <div class="row">
          <div class="box-header with-border">
              ...
              <h2 class="box-title" style="margin-left: 10px;margin-top: 5px;">View Business Unit</h2>
              </div>
              <div class="col-md-3 col-sm-12 col-xs-12">
                  <a href="<?= $this->Url->build(['controller' => 'BusinessUnit', 'action' => 'addBusinessUnit']) ?>" class="btn btn-primary" style="margin-left: 10px;">
